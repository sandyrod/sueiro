<div class="request">
    <span class="request__menu">Inicio | Pedidos</span>
</div>
    ...
    <table class="table">
        ...
        <tbody style="text-align:center;">
          <tr>
            ...
            <td>$4.765</td>
            <td>
                <button class="ordersh__btn">VER DETALLE <i class="far fa-eye"></i></button>
                <button class="ordersh__btnreload">VER DETALLE <i class="fas fa-redo-alt"></i></button>
            </td>
          </tr>
          <tr>
            <th scope="row">#1002</th>
            <td>15/07/2019</td>
            <td class="orders__stadpedido">Ente</td>
            <td>$8.569</td>
            <td>
                <button class="ordersh__btn">VER DETALLE <i class="far fa-eye"></i></button>
                <button class="ordersh__btnreload">VER DETALLE <i class="fas fa-redo-alt"></i></button>
